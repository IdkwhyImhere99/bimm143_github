---
title: "Class_05 Data Visualization with ggplot2"
author: "Evan_Lee(PID:A15093776)"
format: pdf
---

## Using GGPLOT

The ggplot2 package needs to be installed as it does not come with R naturally. 

We use the `install.packages()` function to install ggplot2 
...
```{r}
p + scale_colour_manual (values=c("blue","grey","red")) + 
  labs(title="Gene Expression Changes Due to Drug Treatment",
       x="Control (no drug)",
       y= "Drug Treatment")
```
